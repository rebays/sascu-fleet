...
const { getMe, updateMe,getAllUsers,updateUser,deleteUser, toggleMembership, updatePassword, getAdmins, createAdmin, resetAdminPassword, changeUserRole } = require('../controllers/userController');
...
router.patch('/:id/role', protect, superAdmin, changeUserRole);
